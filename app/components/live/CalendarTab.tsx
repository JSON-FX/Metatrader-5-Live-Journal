          ...
          <table className="w-full">
            ...
            <tbody className="text-center">
              <tr className="border-t border-border/50">
                ...
                <td className="py-2.5"><span className="text-lg font-bold text-profit font-mono">{monthStreaks.winStreak}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{monthStreaks.maxWinStreak}</span></td>
              </tr>
              <tr className="border-t border-border/50">
                <td className="py-2.5 text-left">
                ...
                <td className="py-2.5"><span className="text-lg font-bold text-loss font-mono">{monthStreaks.loseStreak}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{monthStreaks.maxLoseStreak}</span></td>
              </tr>
              <tr className="border-t border-border/50">
                <td className="py-2.5 text-left">
                ...
                <td className="py-2.5"><span className="text-lg font-bold text-profit font-mono">{monthStreaks.winStreakTrades}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{monthStreaks.maxWinStreakTrades}</span></td>
              </tr>
              <tr className="border-t border-border/50">
                <td className="py-2.5 text-left">
                ...
                <td className="py-2.5"><span className="text-lg font-bold text-loss font-mono">{monthStreaks.loseStreakTrades}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{monthStreaks.maxLoseStreakTrades}</span></td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="text-center">
              <tr className="border-t border-border/50">
                ...
                <td className="py-2.5"><span className="text-lg font-bold text-profit font-mono">{allTimeStreaks.winStreak}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{allTimeStreaks.maxWinStreak}</span></td>
              </tr>
              <tr className="border-t border-border/50">
                <td className="py-2.5 text-left">
                  <span className="text-xs text-text-secondary flex items-center gap-1.5"><Flame className="w-3.5 h-3.5 text-loss" /> Losing Days</span>
                </td>
                <td className="py-2.5"><span className="text-lg font-bold text-loss font-mono">{allTimeStreaks.loseStreak}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{allTimeStreaks.maxLoseStreak}</span></td>
              </tr>
              <tr className="border-t border-border/50">
                <td className="py-2.5 text-left">
                  <span className="text-xs text-text-secondary flex items-center gap-1.5"><Flame className="w-3.5 h-3.5 text-profit" /> Winning Trades</span>
                </td>
                <td className="py-2.5"><span className="text-lg font-bold text-profit font-mono">{allTimeStreaks.winStreakTrades}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{allTimeStreaks.maxWinStreakTrades}</span></td>
              </tr>
              <tr className="border-t border-border/50">
                <td className="py-2.5 text-left">
                  <span className="text-xs text-text-secondary flex items-center gap-1.5"><Flame className="w-3.5 h-3.5 text-loss" /> Losing Trades</span>
                </td>
                <td className="py-2.5"><span className="text-lg font-bold text-loss font-mono">{allTimeStreaks.loseStreakTrades}</span></td>
                <td className="py-2.5"><span className="text-lg font-bold text-text-primary font-mono">{allTimeStreaks.maxLoseStreakTrades}</span></td>
              </tr>
            </tbody>
          </table>
        </div>
